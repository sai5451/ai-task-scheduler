...
def generate_successors(
    ...
    """
    Same successor generation logic as A* (pure scheduling expansion).
    """
...
def ucs_search(
    ...
    """
    Uniform Cost Search: selects states with minimum g(n).
    """
    ...
    g_initial = 0
    heapq.heappush(open_list, (g_initial, initial_state))

    while open_list:
        g, current_state = heapq.heappop(open_list)
        ...
        for next_state in successors:
            ...
            heapq.heappush(open_list, (g_next, next_state))
